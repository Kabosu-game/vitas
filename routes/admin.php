...
Route::controller(CurrencyController::class)->name('currency.')->group(function () {
    ...
    Route::get('currency-delete/{id}', 'destroy')->name('destroy');
});
...
Route::get('wallets', [TransactionController::class, 'wallets'])->name('wallets');
Route::get('virutal-cards', [TransactionController::class, 'virtualCardsList'])->name('virtual.cards');
...
Route::group(['prefix' => 'app', 'as' => 'app.', 'controller' => AppSettingsController::class], function () {
    ...
    Route::post('settings-update', 'appSettingsUpdate')->name('settings.update');
});
