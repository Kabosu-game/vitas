    ...
    public function run(): void
    {
        ...
        $templates = [
            ...
            [
                ...
                'salutation'    => 'Bonjour [[full_name]],',
                'message_body'  => '<p>Après examen de votre dossier, nous avons le regret de vous informer que votre demande de prêt n\'a pas pu être accordée.</p><p><strong>Référence :</strong> [[reference]]</p><p>[[message]]</p>',
