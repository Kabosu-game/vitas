...
return [
    'global' => [
        ...
        'elements' => [
            ...
            [
                'type' => 'text', // input fields type
                'data' => 'integer', // data type, string, int, boolean
                'name' => 'account_number_limit', // unique name for field
                'label' => 'Account Number Limit', // you know what label it is
                'rules' => 'required|max:30', // validation rule of laravel
                'value' => '12', // default value if you want
            ],
            [
                'type' => 'dropdown', // input fields type
                'data' => 'string', // data type, string, int, boolean
    ...
    'permission' => [
        ...
        'elements' => [
            ...
            [
                'type' => 'checkbox', // input fields type
                'data' => 'boolean', // data type, string, int, boolean
                'name' => 'card_topup', // unique name for field
                'label' => 'Card Top Up', // you know what label it is
                'rules' => 'required', // validation rule of laravel
                'value' => 1, // default value if you want
            ],
    ...
    'fee' => [
        'title' => 'Site Bonus, Fee, Limit Settings',
        'elements' => [
            [
                'type' => 'text', // input fields type
            ...
            [
                'type' => 'text', // input fields type
                'data' => 'double', // data type, string, int, boolean
                'name' => 'min_fund_transfer', // unique name for field
                'label' => 'Min Fund Transfer', // you know what label it is
                'rules' => 'required|regex:/^\d+(\.\d{1,2})?$/', // validation rule of laravel
            ...
            [
                'type' => 'text', // input fields type
                'data' => 'double', // data type, string, int, boolean
                'name' => 'max_fund_transfer', // unique name for field
                'label' => 'Max Fund Transfer', // you know what label it is
                'rules' => 'required|regex:/^\d+(\.\d{1,2})?$/', // validation rule of laravel
                'value' => 100, // default value if you want
            ],
            [
