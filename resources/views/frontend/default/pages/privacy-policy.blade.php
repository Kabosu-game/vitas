        ...
        <div class="container">
            <div class="privacy-policy-content">
                <div class="privacy-item">
                    ...
                    <p style="color:rgba(3,3,6,0.6);">Nous recueillons des informations personnelles telles que votre nom, adresse, numéro de téléphone, adresse e-mail, informations financières et documents d'identification pour traiter vos demandes de prêt.</p>
                    <h3>3. Comment Nous Obtenons les Données sur Vous</h3>
                    <p style="color:rgba(3,3,6,0.6);">Nous obtenons des données via votre interaction directe avec notre site, vos demandes de prêt, vos communications avec notre support client, et des sources tierces vérifiées pour valider votre identité et votre solvabilité.</p>
                    <h3>4. À Quoi Servent Vos Données</h3>
                    <p style="color:rgba(3,3,6,0.6);">Vos données sont utilisées pour traiter vos demandes de prêt, évaluer votre éligibilité, communiquer avec vous, améliorer nos services, et se conformer aux obligations légales et réglementaires.</p>
                </div>
            </div>
        </div>
    </section>
