...
<section class="banner-area">
                ...
                <div class="banner-content-wrapper">
                    <div class="banner-content">
                        ...
                        <h1 data-aos="fade-right" data-aos-duration="1500" class="title">
                            {{ __('hero_title') }}
                            <span>{{ __('hero_title_brand') }}</span>
                        </h1>
                        <p data-aos="fade-up" data-aos-duration="2000" class="description">
                            {{ __('hero_description') }}
                        </p>
                        <div class="btn-wrrapper d-flex gap-3 align-items-center" data-aos="fade-up" data-aos-duration="2500">
                            <a class="gradient-btn" href="{{ route('register') }}" target="_self">
            ...
            <div class="col-xxl-5 col-xl-6 col-lg-6">
                <div class="banner-thumb-wrapper" data-aos="fade-left" data-aos-duration="2000">
                    <div class="banner-thumb">
                        <img src="{{ asset('global/images/dLsNX2K9uBj3SNukYiQG.png') }}" alt="thumb not found">
                    </div>
                    <div class="user-one">
                        <img src="{{ asset('global/images/HUxM5iSi2CSCdRr5siCf.png') }}" alt="user not found">
                    </div>
                    <div class="user-two">
                        <img src="{{ asset('global/images/QjwmPaTcxacRTIlHQ7J4.png') }}" alt="user not found">
                    </div>
    ...
    <div class="banner-shapes">
        <div class="shape-one">
            <img data-parallax='{"y" : 50, "smoothness": 20}' src="{{ asset('global/images/JLkDDa0oBDODEJSsCVeK.png') }}" alt="shape not found">
        </div>
        <div class="shape-two upDown">
            <img src="{{ asset('global/images/hDDTTddCaKUAH0hPgKkE.png') }}" alt="shape not found">
        </div>
