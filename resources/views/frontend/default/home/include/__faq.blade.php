        ...
        <div class="row align-items-center gy-50">
            <div class="col-xxl-6 col-xl-6 col-lg-6">
                <div class="faq-thumb" data-aos="fade-right">
                    <img class="thumb-normal" src="{{ asset('global/images/1Y1dqiMzx7KAQHF6Ntb9.png') }}" alt="faq thumb not found">
                    <img class="thumb-dark" src="{{ asset('global/images/1Y1dqiMzx7KAQHF6Ntb9.png') }}" alt="faq thumb not found">
                </div>
            </div>
            <div class="col-xxl-6 col-xl-6 col-lg-6">
