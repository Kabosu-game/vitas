            ...
            <div class="col">
                <div class="nav-wrap">
                    ...
                    <div class="nav-right">
                        ...
                        @endauth
                        <div class="single-right">
                            @include('frontend::include.__language_switcher', ['selectId' => 'corp-user-header-lang'])
                        </div>
                        <div class="single-right mob-650-none">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a class="dropdown-item logout" href="{{ url('logout') }}" class="dropdown-item logout" onclick="event.preventDefault();$('#logout-form').submit();"><i style="color: #ed2e2e;" data-lucide="log-out"></i><span>{{ __('Logout') }}</span></a>
                                            </li>
