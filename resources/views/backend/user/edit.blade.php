                                        ...
                                        @else
                                            <div class="admin-user-balance-card">
                                                ...
                                                <div class="wallet-info">
                                                    ...
                                                    <div class="balance">
                                                        {{ setting('currency_symbol', 'global') . $user->balance }}</div>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                ...
                <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="site-tab-bars">
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            ...
                            @can('user-paybacks')
                                <li class="nav-item" role="presentation">
                                    <a href="{{ route('admin.user.edit', ['user' => $user->id, 'tab' => 'paybacks']) }}"
                                        class="nav-link {{ request('tab') == 'paybacks' ? 'active' : '' }}"><i
                                            data-lucide="credit-card"></i>{{ __('Paybacks') }}</a>
                                </li>
                            @endcan
...
@section('script')
    <script>
        ...
        $(document).on('change','#wallet',function(){
            var currency = $(this).find(':selected').data('curr-name');
            if(currency=='Default Wallet'){
