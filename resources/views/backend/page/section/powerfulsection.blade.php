...
@section('content')
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-12">
                        <div class="title-content">
                            <h2 class="title">{{ __('Powerful Features Section') }}</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            <form action="{{ route('admin.page.section.section.update') }}" method="post"
                                ...
                                @csrf
                                <input type="hidden" name="section_code" value="powerfulsection">
                                ...
                                @if($key == 'en')
                                    <div class="site-input-groups row">
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-label">
                                            {{ __('Left Image') }} <small>(824x512)</small>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-label">
                                            {{ __('Mask Shape Image') }} <small>(496x462)</small>
                                        </div>
                                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                                            <div class="wrap-custom-file">
                                                <input type="file" name="mask_shape_img" id="maskShapeImg"
                                                       accept=".gif, .jpg, .png"/>
                                                <label for="maskShapeImg" id="mask_shape_img" @if($data->mask_shape_img)  class="file-ok"
                                                       style="background-image: url({{ asset($data->mask_shape_img) }})" @endif>
                                                    <img class="upload-icon"
                                                         src="{{ asset('global/materials/upload.svg') }}" alt=""/>
                                                    <span>{{ __('Update Image') }}</span>
                                                </label>
                                                @removeimg($data->mask_shape_img,mask_shape_img)
                                            </div>
                                        </div>
                                    </div>
                                @endif
    ...
    <!-- Modal for Add New  -->
    @include('backend.page.section.include.__add_new_powerful')
    <!-- Modal for Add New How It Works End -->

    <!-- Modal for Edit -->
    @include('backend.page.section.include.__edit_powerful')
    <!-- Modal for Edit  End-->

    <!-- Modal for Delete  -->
    @include('backend.page.section.include.__delete_powerful')
